...
const RightSide=()=>{
   ...
   <form onSubmit={handleSubmit(onSubmit)} >
     ...
     <Controller control={control} rules={{required:"CardHolder name is required", pattern: {
            ...
            field.onChange(e);
          }} variant='outlined'  placeholder='e.g.Jane Appleseed' autoComplete='off' id='name' size='small' type='text' fullWidth sx={{'& .MuiInputBase-root':{fontSize:"1vw",fontFamily: "Space Grotesk",fontWeight:"normal",
  ...
  fontStyle: 'normal'}}}/>)} name="name"/>
     ...
     render={({field,fieldState})=>( <TextField value={field.value} onChange={(e)=>{
      ...
      field.onChange(e)
       ...
       size='small' type='text' fullWidth sx={{'& .MuiInputBase-root':{fontSize:"1vw",fontFamily: "Space Grotesk",fontWeight:"normal",
  fontStyle: 'normal'},'& .MuiInputBase-input':{'&:hover':{cursor:"pointer"}},'& .MuiOutlinedInput-root.Mui-focused': { '& fieldset':{border:"1px solid  hsl(278, 94%, 30%) "}},
  '& .MuiOutlinedInput-root:hover': { '& fieldset':{border:"1px solid hsl(278, 94%, 30%)"}}
}} error={!!fieldState.error} helperText={fieldState.error?.message} FormHelperTextProps={{style:{fontSize:"0.6rem",fontFamily: "Space Grotesk",fontWeight:"normal",
...
<LocalizationProvider dateAdapter={AdapterDayjs}>
  ...
  fontStyle: 'normal'}}}
        sx={{width:"12vw", '& .MuiPickersInputBase-sectionContent':{fontSize:"1vw",fontFamily: "Space Grotesk",fontWeight:"normal",
  ...
  fontStyle: 'normal'}}}
        sx={{marginLeft:"1vw",width:"12vw", '& .MuiPickersInputBase-sectionContent':{fontSize:"1vw",fontFamily: "Space Grotesk",fontWeight:"normal",
  fontStyle: 'normal'},'& .MuiPickersInputBase-root.Mui-focused:not(.Mui-error)':{'& fieldset':{border:"1px solid hsl(278, 94%, 30%)"}},'& .MuiPickersInputBase-root:hover':{'& fieldset':{border:"1px solid hsl(278, 94%, 30%)"}},'& .MuiPickersSectionList-root':{padding:"5px 0px",'&:hover':{cursor:"pointer"}}}}/>)}/>
</LocalizationProvider>
<Controller name='cvc' control={control} rules={{required:"Can't be blank",pattern:{value:/^[0-9]{3}$/,message:'Enter valid cvc'}}}
render={({field,fieldState})=>(<TextField type='text'{...field} size='small' placeholder="e.g.123" sx={{marginLeft:"1vw",'& .MuiInputBase-root':{fontSize:"1vw",fontFamily: "Space Grotesk",fontWeight:"normal",
  fontStyle: 'normal'},'& .MuiInputBase-input':{'&:hover':{cursor:"pointer"}},'& .MuiOutlinedInput-root.Mui-focused': { '& fieldset':{border:"1px solid  hsl(278, 94%, 30%) "}},
  '& .MuiOutlinedInput-root:hover': { '& fieldset':{border:"1px solid hsl(278, 94%, 30%)"}}
}} error={!!fieldState.error} helperText={fieldState.error?.message} FormHelperTextProps={{style:{fontSize:"0.6rem",fontFamily: "Space Grotesk",fontWeight:"normal",
  fontStyle: 'normal'}}}/>)} />
  ...
  fontStyle: 'normal',marginTop:"12px",fontSize:"1vw"}}>Confirm</Button>
  </form>
     </> }
     {compl_status === true && <>
     <Box sx={{textAlign:"center",padding:"2vw"}}>
      <img src="Images/icon-complete.svg" alt='no complete' style={{width:"22%",height:"22%"}}/>
      <Typography sx={{fontSize:"1.2vw",fontFamily: "Space Grotesk",fontWeight:"normal",letterSpacing:"2px",
  fontStyle: 'normal',marginTop:"1.5vw"}}>THANK YOU!</Typography>
      <Typography sx={{color:"hsl(212, 12%, 71%)",fontSize:"0.8vw",marginTop:"0.4vw",fontFamily: "Space Grotesk",fontWeight:"normal",
  ...
  fontStyle: 'normal',fontSize:"1vw"}}>Continue</Button>
     </Box> 
     </>}
     </Box>
    </>)
